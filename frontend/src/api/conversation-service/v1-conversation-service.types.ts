...
export interface V1AppConversationStartRequest {
  ...
  fc_ram_size_mib?: number | null; // RAM size in MiB for Firecracker sandboxes
  discover_all_repos?: boolean | null; // Discover skills from all git repos in workspace
  skills_discovery_depth?: number | null; // Max depth for git repo discovery

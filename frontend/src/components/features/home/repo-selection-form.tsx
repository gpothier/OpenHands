  ...
  return (
    <div className="flex flex-col">
      ...
      <BrandButton
        ...
        onClick={() => {
          // Debug: log the selected spec ID, storage size, and RAM size
          console.log(
          ...
          createConversation(
            {
              ...
              discoverAllRepos: discoverAllRepos || undefined,
              skillsDiscoveryDepth: skillsDiscoveryDepth || undefined,
            },
            {
              onSuccess: (data) =>

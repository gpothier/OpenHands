...
export enum I18nKey {
  ...
  SETTINGS$SANDBOX_TYPE = "SETTINGS$SANDBOX_TYPE",
  SETTINGS$SANDBOX_KVM_ENABLED = "SETTINGS$SANDBOX_KVM_ENABLED",
  SETTINGS$SANDBOX_TYPE_DESCRIPTION = "SETTINGS$SANDBOX_TYPE_DESCRIPTION",
  SETTINGS$STORAGE_SIZE = "SETTINGS$STORAGE_SIZE",
  SETTINGS$STORAGE_SIZE_DESCRIPTION = "SETTINGS$STORAGE_SIZE_DESCRIPTION",
  SETTINGS$STORAGE_SIZE_GB = "SETTINGS$STORAGE_SIZE_GB",
  SETTINGS$RAM_SIZE = "SETTINGS$RAM_SIZE",
  SETTINGS$RAM_SIZE_DESCRIPTION = "SETTINGS$RAM_SIZE_DESCRIPTION",
  SETTINGS$RAM_SIZE_MIB = "SETTINGS$RAM_SIZE_MIB",
  ...
  VSCODE$OPEN_IN_LOCAL_VSCODE = "VSCODE$OPEN_IN_LOCAL_VSCODE",
  SSH$URL_NOT_AVAILABLE = "SSH$URL_NOT_AVAILABLE",
  SSH$NOT_AVAILABLE_V0 = "SSH$NOT_AVAILABLE_V0",
  SSH_KEYS$TITLE = "SSH_KEYS$TITLE",
  SSH_KEYS$DESCRIPTION = "SSH_KEYS$DESCRIPTION",
  SSH_KEYS$ADD_KEY = "SSH_KEYS$ADD_KEY",
  SSH_KEYS$KEY_LABEL = "SSH_KEYS$KEY_LABEL",
  SSH_KEYS$KEY_PLACEHOLDER = "SSH_KEYS$KEY_PLACEHOLDER",
  SSH_KEYS$LABEL_PLACEHOLDER = "SSH_KEYS$LABEL_PLACEHOLDER",
  SSH_KEYS$CONFIRM_DELETE = "SSH_KEYS$CONFIRM_DELETE",
  SSH_KEYS$INVALID_KEY = "SSH_KEYS$INVALID_KEY",
  SSH_KEYS$KEY_EXISTS = "SSH_KEYS$KEY_EXISTS",
  SSH_KEYS$LABEL_LABEL = "SSH_KEYS$LABEL_LABEL",
  SSH_KEYS$NO_LABEL = "SSH_KEYS$NO_LABEL",
  SSH_KEYS$NO_KEYS = "SSH_KEYS$NO_KEYS",
  SSH_KEYS$ADDING = "SSH_KEYS$ADDING",
  SSH_KEYS$PUBLIC_KEY_HEADER = "SSH_KEYS$PUBLIC_KEY_HEADER",
  SETTINGS$NAV_SSH_KEYS = "SETTINGS$NAV_SSH_KEYS",
  ...
  SETTINGS$SKILLS_DISCOVERY = "SETTINGS$SKILLS_DISCOVERY",
  SETTINGS$SKILLS_DISCOVERY_DESCRIPTION = "SETTINGS$SKILLS_DISCOVERY_DESCRIPTION",
  SETTINGS$DISCOVER_ALL_REPOS = "SETTINGS$DISCOVER_ALL_REPOS",
  SETTINGS$DISCOVER_ALL_REPOS_DESCRIPTION = "SETTINGS$DISCOVER_ALL_REPOS_DESCRIPTION",
  SETTINGS$SKILLS_DISCOVERY_DEPTH = "SETTINGS$SKILLS_DISCOVERY_DEPTH",
  SETTINGS$SKILLS_DISCOVERY_DEPTH_DESCRIPTION = "SETTINGS$SKILLS_DISCOVERY_DEPTH_DESCRIPTION",
